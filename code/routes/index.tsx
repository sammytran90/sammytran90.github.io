      ...
      <div class="max-w-screen-md mx-auto flex flex-col items-center justify-center">
        ...
        <div class="w-full">
          ...
          <div class="mb-10">
            ...
            <p class="text-gray-500">Chester, England, United Kingdom</p>
            <ul class="list-disc list-inside mt-2">
              <li>Research and implement Microservices</li>
              <li>Develop Internal Tool Web Applications</li>
          ...
          <div class="mb-10">
            ...
            <p class="text-gray-500">Northwich, England, United Kingdom</p>
            <ul class="list-disc list-inside mt-2">
          ...
          <div class="mb-10">
            ...
            <p class="text-gray-500">Vietnam</p>
            <ul class="list-disc list-inside mt-2">
        ...
        <div class="w-full mb-6">
          ...
          <p class="text-lg">Master of Science - MSc, Computing (2019 - 2021)</p>
          
          <h3 class="text-xl font-semibold mt-4">Université Jean Moulin (Lyon III)</h3>
          <p class="text-lg">Bachelor's degree, Marketing (2009 - 2013)</p>
        </div>
        
        <h2 class="text-2xl font-semibold my-4">Top Skills</h2>
        <ul class="list-disc list-inside my-4">
          <li>Cursor</li>
          <li>Unreal Engine</li>
          <li>Material UI</li>
        ...
        <h2 class="text-2xl font-semibold my-4">Certifications</h2>
        <ul class="list-disc list-inside my-4">
          <li>Work-Life Blend: The New Work-Life Balance</li>
          <li>Ten Habits of Great Decision Makers</li>
        </ul>
        
        <h2 class="text-2xl font-semibold my-4">Contact</h2>
        <div class="my-4 text-center">
          <p>Hanoi, Vietnam</p>
          <p>+84865639119 (Mobile)</p>
          <p>trung.trananh0907@gmail.com</p>
          <p>
            <a href="https://www.linkedin.com/in/anh-trung-tran" target="_blank" class="text-blue-500 hover:underline">
              www.linkedin.com/in/anh-trung-tran
            </a>
          </p>
        </div>
      </div>
