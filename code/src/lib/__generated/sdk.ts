...
/** Blog page with title, body, image and other recommended posts [See type definition](https://app.contentful.com/spaces/z68ov00izx50/content_types/blogPage) */
export type BlogPage = Entry & _Node & {
  ...
  recommendedPostsCollection?: Maybe<BlogPageRecommendedPostsCollection>;
  sys: Sys;
  title?: Maybe<Scalars['String']['output']>;
};
...
/** Blog page with title, body, image and other recommended posts [See type definition](https://app.contentful.com/spaces/z68ov00izx50/content_types/blogPage) */
export type BlogPageRecommendedPostsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type BlogPageRecommendedPostsCollection = {
...
export type BlogPageFieldsFragment = { __typename: 'BlogPage', title?: string | null, sys: { __typename?: 'Sys', id: string, spaceId: string }, body?: { __typename?: 'BlogPageBody', json: any } | null };
...
export type BlogPageQuery = { __typename?: 'Query', blogPageCollection?: { __typename?: 'BlogPageCollection', items: Array<(
      { __typename?: 'BlogPage' }
      & BlogPageFieldsFragment
    ) | null> } | null };
...
export const BlogPageDocument = gql`
    query blogPage($locale: String, $preview: Boolean) {
  blogPageCollection(limit: 1, locale: $locale, preview: $preview) {
    items {
      ...BlogPageFields
    }
  }
